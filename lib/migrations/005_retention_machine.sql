-- ============================================================
-- Migration 005: Retention Machine
--
-- Adds columns needed for:
-- - Real membership pricing (avg_membership_price on gyms)
-- - Autopilot mode (autopilot_enabled, autopilot_level on gyms)
...
ALTER TABLE gyms
  ...
  ADD COLUMN IF NOT EXISTS autopilot_level TEXT DEFAULT 'draft_only',
